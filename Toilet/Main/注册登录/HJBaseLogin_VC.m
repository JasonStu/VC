...
- (UILabel *)welcomeLB1{
    if (!_welcomeLB1) {
        _welcomeLB1 = [UILabel new];
        _welcomeLB1.textColor = RGBOF(0x333333);
        _welcomeLB1.font = XXBoldFont(30);
        _welcomeLB1.text = @"欢迎来到";
    }
    return _welcomeLB1;
}
...
- (UILabel *)welcomeLB2{
    if (!_welcomeLB2) {
        _welcomeLB2 = [UILabel new];
        _welcomeLB2.textColor = RGBOF(0xFF9C00);
        _welcomeLB2.font = XXBoldFont(30);
        _welcomeLB2.text = @"全球候鸟度假";
    }
    return _welcomeLB2;
}
